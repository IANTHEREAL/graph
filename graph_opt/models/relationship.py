...
def get_relationship_model(
    ...
    """
    Returns a custom Relationship model with the specified table name and vector length.
    This function is reentrant - it can be called multiple times with the same table name
    without raising TableAlreadyDefinedError.
    """
    ...
    class Relationship(Base):
        ...
        __table_args__ = {"extend_existing": True}  # Enable reentrant behavior
